...
function cleanUp() {
    return del([paths.src.img.clean,paths.src.js.clean,paths.src.vendor.clean, paths.src.scss.dest, paths.src.html.cleanHtml]);
};
...
exports.default = series(cleanUp, html, buildCss, minifyCss, copyVendor, copyVendorCss, copyImages, bundleJs, parallel(browserSync, watchFiles));
